...
var responseFormatter = require('./utils/response-formatter');
...
module.exports = function (api, options) {
    ...
    return function (req, res, next) {
        ...
        return api.exec(methodName, params, req)
            .then(function (data) {
                res.json(responseFormatter.formatResponse(data));
            })
            .fail(function (error) {
                var debugInfo = api.isDebug() ?
                    {
                ...
                res.json(responseFormatter.formatError(error, debugInfo));
            });
    };
};
