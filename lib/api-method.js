...
var ApiMethod = inherit({
     ...
     * @param {Boolean} [method.options.preventThrowingErrors=false] Wrap ApiMethod call in promise to prevent throwing errors.
     ...
     *
     * @returns {Object|Function} params Hash where each property name is a method param and value has ApiMethodParam type.
     */
    getParams: function () {
