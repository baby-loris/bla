...
var ApiMethod = inherit({
    ...
    __constructor: function (method) {
        ...
        if (this._options.hasOwnProperty('hiddenOnDocPage')) {
            console.warn('\033[31m', '[BLA] `hiddenOnDocPage` option is removed. Use `showOnDocPage` option instead.');
        }
    },
    ...
    _normalizeParams: function (values, params) {
        return Object.keys(params).reduce(function (result, key) {
            ...
            var value = values[key] || declaration.defaultValue;
     ...
     * @returns {Boolean}
     */
    getUsedDeprecatedMethods: function () {
        return this._usedDeprecatedMethods;
    },
    ...
    setDescription: function (description) {
        this._usedDeprecatedMethods.push('setDescription');
    ...
    setOption: function (name, value) {
        this._usedDeprecatedMethods.push('setOption');
    ...
    addParam: function (param) {
        this._usedDeprecatedMethods.push('addParam');
    ...
    setAction: function (action) {
        this._usedDeprecatedMethods.push('setAction');
        this._action = action;
        return this;
    }
});
